...
import fttestlog.storage.StorageFileNotFoundException;
...
public class LogController {
  ...
  @GetMapping("/")
  public String listLogs(Model model) throws IOException {

    model.addAttribute("files", storageService
        .loadAll()
        .map(path ->
            MvcUriComponentsBuilder
                .fromMethodName(LogController.class, "serveFile", path.getFileName().toString())
                .build().toString())
